    ...
    <div className="section container">
      <div className="flex justify-center items-center w-full">
        <div className="flex flex-col items-center space-y-[1rem] px-[0.75rem] py-[1rem] border-[1.5px] border-gray-200 rounded-md sm:flex-row sm:space-y-0 sm:space-x-[1rem] sm:py-[1.5rem]">
          ...
          <div className="flex flex-col items-center space-y-[0.75rem] sm:items-start md:space-y-[1rem]">
            <h4 className="text-lightThemeColor font-poppinsSemibold text-center md:text-h3">
              We tour NyumbaHub website for your first tour
            </h4>
            <p className="text-textColor font-poppinsLight text-smaller sm:text-small md:leading-5">
              ...
              varieties of 'fantasy' properties.
            </p>
          </div>
        </div>
      </div>
