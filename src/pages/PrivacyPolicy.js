  ...
  return (
    <div className="page pt-[2rem] pb-[4rem]">
      ...
      <div className="container flex flex-col justify-start items-start">
        ...
        <div className="flex flex-col space-y-[2.25rem] mt-[2rem] sm:space-y-[2.75rem]">
          <div className="flex flex-col space-y-[1rem]">
            ...
            <p className="text-textColor">
              ...
              committed to protecting the privacy and security of you personal
            ...
            <div className="flex flex-col text-darkThemeColor space-y-[1.5rem] pl-[0.5rem]">
              <div className="flex flex-col space-y-[1rem]">
                ...
                <ul className="flex flex-col space-y-[0.5rem] pl-[2rem] text-textColor list-disc">
                  ...
                  <li>Location Data i.e. GPS coordinates</li>
                </ul>
              </div>
              <div className="flex flex-col space-y-[1rem]">
                <p className="text-darkThemeColor font-poppinsRegular text-default sm:text-h3">
          ...
          <div className="flex flex-col space-y-[1rem]">
            ...
            <div className="flex flex-col text-darkThemeColor space-y-[1.5rem] pl-[0.5rem]">
              <div className="flex flex-col space-y-[1rem]">
                ...
                <ul className="flex flex-col space-y-[0.5rem] pl-[2rem] text-textColor list-disc">
                  <li>
                    Share data with third-party service providers like MongoDB
                    database for technical and operational support
                  </li>
                </ul>
              </div>
              <div className="flex flex-col space-y-[1rem]">
              ...
              <div className="flex flex-col space-y-[1rem]">
                ...
                <ul className="flex flex-col space-y-[0.5rem] pl-[2rem] text-textColor list-disc">
                  <li>
                    ...
                    information may be transfered. We'll let you know beforehand
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className="flex flex-col space-y-[1rem]">
            ...
            <ul className="flex flex-col space-y-[0.5rem] pl-[2rem] text-textColor list-disc">
              ...
              <li>
                We do not knowingly collect or solicit personal information for
                minors
              </li>
            </ul>
          </div>
