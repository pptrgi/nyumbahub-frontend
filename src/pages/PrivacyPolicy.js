      ...
      <FadeInAnimation delay={true}>
        <div className="custom_container pt-[5rem] pb-[3rem] md800:pt-[11rem]">
          ...
          <div className="flex flex-col justify-start items-start">
            ...
            <div className="flex flex-col space-y-[2.25rem] mt-[3rem] md480:space-y-[2.75rem]">
              <div className="flex flex-col space-y-[1rem]">
                <h3 className="text-lightThemeColor font-poppinsRegular text-h3 md480:text-h2">
                  Introduction
                </h3>
              ...
              <div className="flex flex-col space-y-[1rem]">
                ...
                <div className="flex flex-col text-darkThemeColor space-y-[1.5rem] pl-[0.5rem]">
                  <div className="flex flex-col space-y-[1rem]">
                    <p className="text-darkThemeColor font-poppinsRegular text-default md480:text-h3">
            ...
            <p className="text-lightThemeColor mt-[3.5rem]">
              By using our services, you consent to the practices outlined in
              this Privacy Policy. It's important to review this policy
              regularly and ensure you understand and agree to its terms. You
              can also check our{" "}
              <span className="text-ctaColor hover:font-poppinsLight">
