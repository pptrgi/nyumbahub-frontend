...
const TermsOfService = () => {
  return (
    <div className="page pt-[2rem] pb-[4rem]">
      <div className="flex justify-center items-center mb-[2.25rem]">
        ...
        <div className="flex flex-col space-y-[2rem] mt-[2rem] sm:space-y-[2.5rem]">
          <div className="flex flex-col space-y-[0.75rem]">
            ...
            <p className="text-textColor">
              ...
              finding service referred to as NyumbaHub Homes provided by Lifen
          ...
          <div className="flex flex-col space-y-[0.75rem]">
            ...
            <p className="text-textColor">
              By accessing or using the NyumbaHub service, you agree to be bound
          ...
          <div className="flex flex-col space-y-[0.75rem]">
            ...
            <p className="text-textColor">
              NyumbaHub Homes strives to provide accurate and currrent
              information about vacant properties, but it does not guarantee the
              availability, condition, or accuracy or any listings. Users are
              advised to independently verify the property details before making
              any decisions.
            </p>
          </div>
          <div className="flex flex-col space-y-[0.75rem]">
            ...
            <p className="text-textColor">
              ...
              modify, distribute, or publicy display any content from NyumbaHub
          ...
          <div className="flex flex-col space-y-[0.75rem]">
            ...
            <p className="text-textColor">
              NyumbaHub Homes values your privacy and handles your personal
          ...
          <div className="flex flex-col space-y-[0.75rem]">
            ...
            <p className="text-textColor">
              ...
              use or inability to use the NyumbaHub service, including but not
              limited to errors, omissions, interruptions, defects, delays or
              viruses.
            </p>
          </div>
          <div className="flex flex-col space-y-[0.75rem]">
            ...
            <p className="text-textColor">
              ...
              any claims, damages, liabilites or expenses arising from their use
              of the NyumbaHub service or violation of these terms.
            </p>
          </div>
          <div className="flex flex-col space-y-[0.75rem]">
            <h4 className="text-lightThemeColor font-poppinsSemibold font-mediumWeight text-default sm:text-h3">
            ...
            <p className="text-textColor">
              ...
              discontinue the NyumbaHub service or any part thereof, at any time
              without prior notice. Changes to these terms will be effective
          ...
          <div className="flex flex-col space-y-[0.75rem]">
            ...
            <p className="text-textColor">
              ...
              accordance with the laws of Kenya. Any disputes arising out of or
              in connection with these terms shall be subject to the exclusive
              jurisdiction fo the courts of Kenya.
            </p>
          </div>
          <div className="flex flex-col space-y-[0.75rem]">
            <h4 className="text-lightThemeColor font-poppinsSemibold font-mediumWeight text-default sm:text-h3">
